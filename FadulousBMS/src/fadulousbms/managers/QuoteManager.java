 ...
 */
public class QuoteManager implements BusinessObjectManager
{
    ...
    /*public void setSelectedQuote(int index)
    {
        if(index>=0 && index<quotes.length)
        {
            ...
            IO.log(getClass().getName(), IO.TAG_ERROR, "Quote to be assigned as selected is invalid[null].");
            //selected_quote=null;
        }
    }*/
                ...
                if(!smgr.getActive().isExpired())
                {
                    ...
                    if(quotes!=null)
                    {
                        if(quotes.length>0)
                        {
                            ...
                            IO.showMessage("No quotes", "no quotes found in database.", IO.TAG_INFO);
                        }
                    }else{
                        IO.log(getClass().getName(), IO.TAG_WARN, "quotes object is null.");
                        IO.showMessage("No quotes", "no quotes found in database.", IO.TAG_INFO);
                    }
    ...
    public boolean createQuoteItem(String quote_id, ArrayList params,ArrayList<AbstractMap.SimpleEntry<String,String>> headers) throws IOException
    {
        ...
        HttpURLConnection connection = RemoteComms.postData("/api/quote/resource/add/"+quote_id, params, headers);
